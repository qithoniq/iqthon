...
def start_assistant(shortname):
    ...
    if shortname.startswith("__"):
        ...
        path = Path(f"qithon/plugins/assistant/{shortname}.py")

        name = "qithon.plugins.assistant.{}".format(shortname)
        ...
        sys.modules["qithon.plugins.assistant" + shortname] = mod
