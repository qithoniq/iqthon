...
__license__ = "كـتابة وتـعديل فريـق بابل ميوس"

__author__ = "بابل ميوس <https://T.ME/qithon>"

__copyright__ = "JEPTHON TEAM (C) 2020 - 2021  " + __author__

jepiq.version = __version__

qiiq.tgbot.version = __version__
...
if Config.UPSTREAM_REPO == "qithoniq":
    ...
    UPSTREAM_REPO_URL = "https://github.com/qithoniq/qithon"
